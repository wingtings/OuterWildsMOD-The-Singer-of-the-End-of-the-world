...
> 玩家闯入一座困于鸥停之雨的城市，在 22 分钟的循环中拼凑出歌者与凡人的故事，修复扩音装置让歌声传遍城市，使凡人终于听到歌者的声音并走向她。

### 场景（两颗星球）

| 星球 | 地点 | 内容 | 图形学效果 |
| ---- | ---- | ---- | ---------- |
| 世末之城 | 雨中广场 | 歌者日记壁文 + 天依NPC + 扩音器零件A | 体积雨 + 涟漪着色器 |
| 世末之城 | 废弃音乐厅 | 歌者NPC + 扩音装置（插槽谜题） | 声波可视化 |
| 世末之城 | 高塔观测台 | 恒星异变观测 + 扩音器零件B | God Ray |
| 神谕之境 | 赌约石碑 | 赌约三条规则 + 第三者条款 | 全息投影着色器 |
| 神谕之境 | 录音石 | 神明言和的声音独白 | — |
...
- 两颗自定义星球：世末之城（暴雨城市）+ 神谕之境（赌约石碑）
- 歌者/天依角色模型（使用模之屋 MMD 资产 https://www.aplaybox.com/details/model/hHfwCU9wl51r ）
- 核心谜题：修复扩音装置让歌声传遍城市
- 信号探测器追踪歌者歌声
- Nomai 翻译器阅读歌者日记和赌约石碑
- Ship Log 飞行日志知识图谱（8 个节点）
- True End 结局演出
